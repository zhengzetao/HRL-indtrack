...
class ActorCriticPolicy(nn.Module):
    ...
    def _get_latent(self, obs: th.Tensor, last_action: th.Tensor = None) -> Tuple[th.Tensor, th.Tensor]:
        """
    ...
    def _predict(self, observation: th.Tensor) -> th.Tensor:
        ...
        """
        latent_pi, _, latent_sde = self._get_latent(observation.permute(0,2,1))
    ...
    def evaluate_actions(self, obs: th.Tensor, actions: th.Tensor) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        obs = obs.view(buffer_size, stock_num, lookback)
